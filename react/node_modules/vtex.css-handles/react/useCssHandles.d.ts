import type { CssHandlesList, CssHandlesOptions, CssHandlesBag } from './CssHandlesTypes';
/**
 ...
 */
declare const useCssHandles: <T extends CssHandlesList>(handleList: T, options?: CssHandlesOptions<T>) => CssHandlesBag<T>;
